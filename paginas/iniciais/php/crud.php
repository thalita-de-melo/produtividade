...
<div class="main">
        <div>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Eighth navbar example">
                <div class="container">
                  <a class="navbar-brand" href="http://dpsme.ml/produtividade/menu.html">Produtividade</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarsExample07">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="http://dpsme.ml/produtividade/menu.html">Inicio</a>
                      </li>
                      <li class="nav-item">
...
<?php       
    ...
    if($linhas > 0){
      ...
      <thead class='thead-light'> 
          <tr bgcolor='#5FAEC2' style='font-weight:
      bold'>
              <th>Excluir</th>
              <th>ESCOLA</th> 
              <th>TURMA</th> 
