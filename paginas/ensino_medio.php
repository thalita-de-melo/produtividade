                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content rounded-4 shadow bg-light">
                              <div class="modal-body p-4">
                                ...
                                <a class="btn btn-lg btn-primary mt-5 w-100" href="medio/add-turma.php" role="button">Clique Aqui</a>
                              </div>
                            </div>
                          </div>  
                        </div>
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content rounded-4 shadow bg-light">
                              <div class="modal-body p-4">
                                ...
                                <a class="btn btn-lg btn-primary mt-5 w-100" href="medio/verturmas.php" role="button">Clique Aqui</a>
                              </div>
                            </div>
                          </div> 
                      </div> 
