...
<div class="container mt-5">
        ...
        <a class="btn btn-info text-white" href="../verturmas.php" role="button">Ver turmas</a>
            <a class="btn btn-danger" href="../add-turma-c-3-4.php" role="button">Voltar</a>
        </div>
    </form>
...
$query = "INSERT INTO turmas_eja VALUES (CURRENT_TIMESTAMP,'$escola','$id','$ano','$mat','$av_relatorio',0,
'$av_notas','$azul_todas','$azul_pt','$azul_mat',0,'$azul_ingles','$azul_hist','$azul_geo','$azul_cien',
'$azul_arte','$azul_ed_fis','$professor_pt','$professor_mat', '$professor_ingles','$professor_hist','$professor_geo',
'$professor_cien','$professor_arte','$professor_ed_fis')"; 
