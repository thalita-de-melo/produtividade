...
<?php       
    ...
    $query = "select * from turmas_eja where ano like '%$searchq%' AND escola like '%$escola%' ORDER BY id ASC"; 
    ...
    if($linhas > 0){
      ...
      <thead class='thead-light'> 
          <tr bgcolor='#5FAEC2'  >
              ...
              <th>NOTA AZUL PT</th>
              <th>NOTA AZUL MAT</th>
              <th>NOTA AZUL SOC_NAT</th>

              <th>NOTA AZUL INGLES</th>
              <th>NOTA AZUL HIST</th>
              <th>NOTA AZUL GEO</th>
              <th>NOTA AZUL CIEN</th>  
              <th>NOTA AZUL ARTES</th>  
              <th>NOTA AZUL ED_FIS</th> 
          ...
          while ($row = $result->fetch_assoc()){
              ...
              <td>".$row["azul_cien"]."</td> <td>".$row["azul_arte"]."</td> 
              <td> ".$row["azul_ed_fis"]."</td> <td> ".$row["professor_pt"]."</td> 
              <td> ".$row["professor_mat"]."</td> <td> ".$row["professor_ingles"]."</td> 
