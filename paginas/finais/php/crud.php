    ...
    if($linhas > 0){
      ...
      <thead class='thead-light'> 
          ...
          while ($row = $result->fetch_assoc()){
              ...
              echo "<tr class='' style=''>  <td><button type ='submit' class='btn btn-danger mt-2' onClick='' name='apagar'><i class='bi bi-trash' syle='font-size: 20px;'></i></button></td> <td>".$row["escola"]." </td> <td>".$row["id"]." </td> <td>".$row["ano"]." </td> <td> ".$row["mat"]." </td> <td> ".$row["av_relatorio"]." </td> <td>".$row["av_notas"]." </td> <td>".$row["azul_todas"]."</td> <td> ".$row["professor_pt"]."</td>  <td>".$row["azul_pt"]."</td> <td> ".$row["professor_mat"]."</td> <td>".$row["azul_mat"]."</td> <td> ".$row["professor_cien"]."</td> <td>".$row["azul_cien"]."</td> <td> ".$row["professor_geo"]."</td> <td>".$row["azul_geo"]."</td> <td> ".$row["professor_hist"]."</td> <td>".$row["azul_hist"]."</td> <td> ".$row["professor_ed_fis"]."</td> <td>".$row["azul_ed_fis"]."</td> <td> ".$row["professor_ingles"]."</td> <td>".$row["azul_ingles"]."</td>  <td> ".$row["professor_arte"]."</td> <td>".$row["azul_arte"]."</td>  </tr>";
              echo "</form>";
            }
      }else{
